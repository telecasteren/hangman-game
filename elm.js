...
var $author$project$Main$wordDecoder = A2($elm$json$Json$Decode$field, 'word', $elm$json$Json$Decode$string);
var $author$project$Main$fetchWord = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$NewPhrase, $author$project$Main$wordDecoder),
		url: 'https://snapdragon-fox.glitch.me/word'
	});
var $author$project$Main$init = _Utils_Tuple2($author$project$Main$Loading, $author$project$Main$fetchWord);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					return _Utils_Tuple2(
						$author$project$Main$Running(
							_Utils_update(
								gameState,
								{
									guesses: A2($elm$core$Set$insert, _char, gameState.guesses)
								})),
			...
			case 'Restart':
				return _Utils_Tuple2($author$project$Main$Loading, $author$project$Main$fetchWord);
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					var phrase = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Running(
							{guesses: $elm$core$Set$empty, phrase: phrase}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$viewGameState = function (gameState) {
	var phraseSet = $elm$core$Set$fromList(
		A2($elm$core$String$split, '', gameState.phrase));
	var phraseHtml = A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			...
			A2(
				$elm$core$List$map,
				function (_char) {
					return (_char === ' ') ? ' ' : (A2($elm$core$Set$member, _char, gameState.guesses) ? _char : '_');
				},
				A2($elm$core$String$split, '', gameState.phrase))));
	var failuresHtml = A2(
		$elm$html$Html$div,
		...
		A2(
			...
			A2(
				...
				$elm$core$Set$toList(gameState.guesses))));
	var buttonsHtml = A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('button'),
						$elm$html$Html$Attributes$class('restart')
					]),
				_List_fromArray(
					[
